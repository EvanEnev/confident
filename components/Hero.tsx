      ...
      <div className="wrap">
        <div className="grid grid-cols-[1.05fr_0.95fr] gap-12 items-end max-[900px]:grid-cols-1">
          <div>
            ...
            <p className="max-w-[420px] mt-7 text-ink-2 text-[17px] leading-[1.5]">
            ...
            <div className="grid grid-cols-3 gap-6 mt-10 pt-7 border-t border-line-soft max-w-[520px] max-[560px]:grid-cols-2">
              ...
              <div>
                <div className="font-serif text-[28px] leading-none">
                  07<span className="text-ink-3">—</span>22
                </div>
          ...
          <div>
            <div className="relative aspect-[4/5] rounded-sm overflow-hidden bg-bg-3">
              ...
              <div className="absolute right-[18px] top-[18px] w-[110px] h-[110px] rounded-full bg-accent text-paper grid place-items-center font-serif text-[15px] leading-[1.1] text-center p-[10px] rotate-[-8deg] shadow-[0_12px_40px_-12px_color-mix(in_oklch,var(--ink)_40%,transparent)]">
                <div>
                  <span className="font-mono text-[9px] tracking-[0.1em] uppercase block mb-0.5 opacity-75">сезон</span>
                  Груша&nbsp;&amp;<br />корица
                </div>
              </div>
            </div>
