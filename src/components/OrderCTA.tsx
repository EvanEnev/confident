export default function OrderCTA() {
  return (
    <section className="py-30 relative" id="order">
      <div className="wrap">
        <div className="cta-card bg-ink text-bg rounded relative overflow-hidden grid grid-cols-[1.3fr_1fr] gap-16 items-end px-16 py-[72px] transition-colors duration-300 max-[900px]:grid-cols-1 max-[900px]:px-8 max-[900px]:py-12 max-[900px]:gap-8 max-[560px]:px-6 max-[560px]:py-9">
          <div>
            ...
            <h3 className="font-serif font-normal text-[clamp(44px,5vw,72px)] leading-[0.95] tracking-[-0.02em] relative z-10">
              Ваш кофе —<br />
              <em className="italic text-accent">через 10 минут</em>
            </h3>
          </div>
          ...
          <div className="relative z-10">
            ...
            <div className="flex flex-col gap-2.5">
              <a href='https://eda.yandex.ru/r/im_confident?placeSlug=im_confident_starovatutinskij_proezd_14' className="flex items-center justify-between px-[22px] py-4 bg-accent border-accent border rounded-full transition-all duration-200 cursor-pointer text-bg font-sans text-[15px] hover:bg-bg hover:text-ink hover:border-bg">
